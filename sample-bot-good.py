...
def main():
    ...
    while True:
        ...
        if message["type"] == "close":
            ...
            if message["order_id"] == valbz_id_buy_list:
                valbz_buy_amt -= message["size"]
            if message["order_id"] == valbz_id_sell_list:
                valbz_sell_amt -= message["size"]
            print(message)
            ...
            if message["symbol"] == "VALE":
                ...
                if vale_bid_price == None or valbz_bid_price == None:
                    x = 0
                elif valbz_bid_price > vale_bid_price and valbz_sell_amt == 0:
                    id_current += 1
                    exchange.send_cancel_message(order_id=valbz_id_sell_list)
                    exchange.send_cancel_message(order_id=valbz_id_buy_list)
                    valbz_id_sell_list = id_current
                    exchange.send_add_message(order_id=id_current, symbol="VALBZ", dir=Dir.SELL, price=vale_bid_price, size=10)
                    valbz_buy_amt = 0
                    valbz_sell_amt = 10
                ...
                if vale_ask_price == None or valbz_ask_price == None:
                    x = 0
                elif vale_ask_price > valbz_ask_price and valbz_buy_amt == 0:
                    id_current += 1
                    exchange.send_cancel_message(order_id=valbz_id_sell_list)
                    exchange.send_cancel_message(order_id=valbz_id_buy_list)
                    valbz_id_buy_list = id_current
                    exchange.send_add_message(order_id=id_current, symbol="VALBZ", dir=Dir.BUY, price=vale_ask_price, size=10)
                    valbz_buy_amt = 10
                    valbz_sell_amt = 0
